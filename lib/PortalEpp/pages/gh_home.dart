                    ...
                    children: [
                      ...
                      Row(
                        children: [
                          ...
                          Container(
                            child:
                                FormInput("Nombre:", value.nombreSelect,value.setnombreSelect),
                            width: 300,
                          ),
                          Container(
                            width: 30,
                          ...
                          Container(
                            child: FormInput(
                                "Apellido:", value.apellidoSelect,value.setapellidoSelect),
                            width: 300,
                          ),
                          Container(
                            width: 30,
                          ...
                          Container(
                            child:
                                FormInput("Cedula:", value.cedulaSelect,value.setcedulaSelect),
                            width: 300,
                          ),
                        ],
                      ),
                      ...
                      Row(
                        children: [
                          ...
                          DateCampo(
                              context, registerFormProvider.fecha, fechaController),
                          Container(
                            width: 30,
                          ),
                          DropdowntextArea(
                      ...
                      Row(
                        children: [
                          ...
                          Container(
                            child: FormInput("Cargo:", value.cargoSelect,value.setcargoSelect),
                            width: 300,
                          ),
                          Container(
                            width: 30,
                      ...
                      Row(
                        children: [
                          ...
                          Container(
                            child:
                                FormInput("Ciudad:", value.ciudadSelect,value.setciudadSelect),
                            width: 300,
                          ),
                          Container(
                            width: 30,
                ...
                Container(
                  child: Row(children: [
                    ...
                    Column(
                      children: [
                        Container(
                          child: FormInput("Cantidad:", value.botasCantidad,value.setBotasCantidad),
                          width: 300,
                        ),
                        SizedBox(
                          height: 10,
                        ...
                        Container(
                          child: FormInput("Proveedor:", value.botasProveedor,value.setBotasProveedor),
                          width: 300,
                        ),
                      ],
                    ),
                ...
                Container(
                  child: Row(children: [
                    ...
                    Column(
                      children: [
                        Container(
                          child: FormInput("Cantidad:", value.cascosCantidad,value.setCascoCantidad),
                          width: 300,
                        ),
                        SizedBox(
                          height: 10,
                        ...
                        Container(
                          child: FormInput("Proveedor:", value.cascosProveedor,value.setCascoProveedor),
                          width: 300,
                        ),
                      ],
                    ),
                  ...
                  child: Row(children: [
                    ...
                    Column(
                      children: [
                        Container(
                          child:
                              FormInput("Cantidad:", value.camisetasCantidad,value.setCamisetasCantidad),
                          width: 300,
                        ),
                        SizedBox(
                          height: 10,
                        ...
                        Container(
                          child: FormInput("Proveedor:", value.camisetasProveedor,value.setCamisetasProveedor),
                          width: 300,
                        ),
                      ],
                    ),
                ...
                Container(
                  child: Row(children: [
                    ...
                    Column(
                      children: [
                        Container(
                          child: FormInput("Cantidad:", value.camisasCantidad,value.setCamisasCantidad),
                          width: 300,
                        ),
                        SizedBox(
                          height: 10,
                        ...
                        Container(
                          child:
                              FormInput("Proveedor:", value.camisasProveedor,value.setCamisasProveedor),
                          width: 300,
                        ),
                      ],
                    ),
                ...
                Container(
                  child: Row(children: [
                    ...
                    Column(
                      children: [
                        Container(
                          child: FormInput("Cantidad:", value.chalecosCantidad,value.setChalecossCanitdad),
                          width: 300,
                        ),
                        SizedBox(
                          height: 10,
                        ...
                        Container(
                          child:
                              FormInput("Proveedor:", value.chalecosProveedor,value.setChalecossCanitdad),
                          width: 300,
                        ),
                      ],
                    ),
