...
class PortalEstadoMilagro extends StatelessWidget {
  String query;

  PortalEstadoMilagro(this.query,{Key? key}) : super(key: key);
  @override
  Widget build(BuildContext context) {
    Future<List<TablasMilagroConsulta>> dataLista = obtenerTablasMilagroConsulta();
    TextEditingController _textoController = TextEditingController(text: "");
    return Scaffold(
      appBar: AppBar(
        automaticallyImplyLeading: false,
        title: Text('Portal de acceso Ransa Milagro'),
        actions: [
          IconButton(
      ...
      body: Stack(
        children: [
                ...
                title: TextField(
                    ...
                    onSubmitted: (_) {
                      Navigator.push(
                          ...
                          MaterialPageRoute(
                              builder: ((context) =>
                                  PortalEstadoMilagro(_textoController.text))));
                    },
          ...
          Center(
            child: FutureBuilder<List<TablasMilagroConsulta>>(
              future: dataLista,
